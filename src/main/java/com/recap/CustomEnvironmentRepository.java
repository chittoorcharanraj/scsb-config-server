...
public class CustomEnvironmentRepository implements EnvironmentRepository, Ordered {
	...
	public List<Map<String, Object>> getImsLocationData(String imsLocation) {
		String sql = "select prop.p_key, prop.p_value from scsb_properties_t prop where institution_code IS NULL AND ims_location_code=? and active='Y'";
	...
	public List<Map<String, Object>> getInstitutionData(String institution) {
		String sql = "select prop.p_key, prop.p_value from scsb_properties_t prop where institution_code=? and active='Y'";
		List<Map<String, Object>> result = null;
		try {
