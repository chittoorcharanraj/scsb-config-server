...
public class RecapConstants {
    ...
    public static final String SQL_INSTITUTION_RECORDS = "select p_key, p_value from scsb_properties_t where institution_code=? and active='Y'";
    ...
    public static final String SQL_IMS_LOCATION_RECORDS = "select p_key, p_value from scsb_properties_t where institution_code IS NULL AND ims_location_code=? and active='Y'";
